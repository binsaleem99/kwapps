-- ============================================
-- KW APPS Credit-Based Billing System Migration
-- ============================================
-- Created: 2025-12-04
...
CREATE UNIQUE INDEX idx_one_active_subscription_per_user ON user_subscriptions(user_id) WHERE status = 'active';
...
-- Index
CREATE INDEX idx_credit_operations_type ON credit_operations(operation_type);
CREATE INDEX idx_credit_operations_active ON credit_operations(is_active);
...
CREATE INDEX idx_credit_transactions_bonus_date ON credit_transactions(bonus_date) WHERE transaction_type = 'bonus';
...
-- Index
CREATE INDEX idx_daily_bonus_log_user_date ON daily_bonus_log(user_id, bonus_date);
CREATE INDEX idx_daily_bonus_log_subscription ON daily_bonus_log(subscription_id);
...
-- Indexes
CREATE INDEX idx_trial_subscriptions_user_id ON trial_subscriptions(user_id);
CREATE INDEX idx_trial_subscriptions_ends_at ON trial_subscriptions(ends_at);
CREATE INDEX idx_trial_subscriptions_payment_status ON trial_subscriptions(payment_status);
