-- ====================================================================
-- TEMPLATES SYSTEM MIGRATION - RUN THIS ENTIRE FILE AT ONCE
-- ====================================================================
...
-- RLS Policies
DROP POLICY IF EXISTS "Anyone can view active templates" ON app_templates;
...
DROP POLICY IF EXISTS "Users can record template usage" ON template_usage;
...
-- Create trigger
DROP TRIGGER IF EXISTS trigger_update_templates_updated_at ON app_templates;
